...
stargazer(BE_model, FE_model, RE_model, 
          title="Resultados", dep.var.labels=c("Tasa de criminalidad"),          
          column.labels = c("Between (BE)", "Within (EF)","Random Effects (RE)" ),
          covariate.labels=c('$P_{A}$','$P_{C}$','$P_{P}$','S','Police','Density','Percent of young male','WCON','WTUC','WTRD','WFIR','WSER','WMFG','WFED','WSTA','WLOC','West','Central','Urban','Percent minority'),
